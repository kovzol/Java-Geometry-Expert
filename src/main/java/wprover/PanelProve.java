...
//        }
    ...
    String setNode(Cond co) {
        ...
        if (rule >= 1 && rule <= 43) {
            ...
            String url = BuildInfo.getRepoUrl() + "/blob/master/src/main/resources/docs/web/Rule" + ruleStr + ".jpg?raw=true";
            ret += ", URL=\"" + url + "\"";
        }
        else {
    ...
    Node graphvizNode(Cond co) {
        ...
        if (rule >= 1 && rule <= 43) {
            ...
            String url = BuildInfo.getRepoUrl() + "/blob/master/src/main/resources/docs/web/Rule" + rule + ".jpg?raw=true";
