...
public class Elim extends Gr
{
      ...
      ElTerm lratio_md1(Var var, int y, int u, int v, XTerm p1, XTerm p2, XTerm q1, XTerm q2)
      {
            if (print_geo)
            {
                  gprint("\nlratio_md1" + y + " " + u + " " + v);
...
//var = (py a y y c)
      ElTerm lratio_md2(Var var, int y, int u, int v, XTerm p1, XTerm p2, XTerm q1, XTerm q2)
      {
            return (mk_elim(var,
      ...
      ElTerm pratio_md1(Var var, int y, int w, int u, int v, XTerm p1, XTerm p2)
      {
...
/*    case 4: case -4: return(pminus(trim_vec(v,0),trim_vec(u,0))); */
      ...
      ElTerm pratio_md2(Var var, int y, int w, int u, int v, XTerm p1, XTerm p2)
      {
            return (mk_elim(var,
      ...
      ElTerm pe_v_pratio(Var var, int y, int w, int u, int v, XTerm p1, XTerm p2)
      {
            if (print_geo)
            {
                  gprint("pratio: \n");
      ...
      ElTerm pe_r_pratio(Var var, int n2, int n1, int d2, int d1, int y, int w, int u, int v, XTerm p1, XTerm p2)
      {
      ...
      ElTerm pe_a_pratio(Var var, int n1, int n2, int n3, int n4, int y, int w, int u, int v, XTerm p1, XTerm p2)
      {
            ElTerm e1;
      ...
      ElTerm pe_g_pratio(Var var, int n1, int n2, int n3, int n4, int y, int w, int u, int v, XTerm p1, XTerm p2)
      {
            ElTerm e1;
            int n;
            XTerm q1, q2;
      ...
      ElTerm pe_v_ipp(Var var, int y, int w, int u, int v, int r, int p, int q)
      {
            int n;
            if (w == v)
            {
      ...
      ElTerm pe_r_ipp(Var var, int n1, int n2, int d1, int d2, int y, int w, int u, int v, int r, int p, int q)
      {
            int n;
            if (print_geo)
      ...
      ElTerm pe_a_ipp(Var var, int n1, int n2, int n3, int n4, int y, int w, int u, int v, int r, int p, int q)
      {
            int n;
      ...
      ElTerm pe_g_ipp(Var var, int n1, int n2, int n3, int n4, int y, int w, int u, int v, int r, int p, int q)
      {
            int n;
            Var v1;
            ElTerm e1;
      ...
      ElTerm pe_r_ill(Var var, int n1, int n2, int d1, int d2, int y, int u, int v, int i, int j)
      {
            int n0;
      ...
      ElTerm pe_a_ill(Var var, int n1, int n2, int n3, int n4, int y, int u, int v, int i, int j)
      {
            int n;
            if (v < u)
            {
      ...
      ElTerm pe_g_ill(Var var, int n1, int n2, int n3, int n4, int y, int u, int v, int i, int j)
      {
            int n;
            ElTerm e1;
            XTerm p1, p2;
      ...
      ElTerm pe_vec_ill(Var var, int n1, int n2, int y, int u, int v, int i, int j)
      {
            int n;
      ...
      ElTerm pe_r_ilp(Var var, int n1, int n2, int d1, int d2, int y, int u, int v, int r, int p, int q)
      {
      ...
      ElTerm pe_a_ilp(Var var, int n1, int n2, int n3, int n4, int y, int u, int v, int r, int p, int q)
      {
            int n;
            if (v < u)
            {
      ...
      ElTerm pe_g_ilp(Var var, int n1, int n2, int n3, int n4, int y, int u, int v, int r, int p, int q)
      {
            int n;
            Var v1;
            ElTerm e1;
...
/*  if (print_geo)  printf("\r\ntrim_g %d %d %d %d\r\n",p1,p2,p3,p4); */
      ...
      ElTerm tratio_a_md1(Var v_a, int y, int w, int u, int v, XTerm p1, XTerm p2)
      {
            return (mk_elim(v_a,
      ...
      ElTerm tratio_g_md1(Var v_a, int y, int w, int u, int v, XTerm p1, XTerm p2)
      {
            return (mk_elim(v_a,
      ...
      ElTerm tratio_md2(Var v_a, int n3, int n4, int y, int w, int u, int v, XTerm p1, XTerm p2)
      {
            return (mk_elim(v_a,
      ...
      ElTerm pe_v_tratio(Var v_a, int y, int w, int u, int v, XTerm p1, XTerm p2)
      {
            if (print_geo)
      ...
      ElTerm pe_r_tratio(Var v_a, int n1, int n2, int n3, int n4, int y, int r, int p, int q, XTerm p1, XTerm p2)
      {
            if (n2 == y && n4 == y)
            {
                  if (xcoll(n1, r, y))
      ...
      ElTerm pe_a_tratio(Var v_a, int n1, int n2, int n3, int n4, int y, int w, int u, int v, XTerm p1, XTerm p2)
      {
            if (xperp(n2, n4, u, v)) return (mk_elim(v_a, trim_a(w, n2, n3, n4), get_n(1L)));
            return (tratio_a_md1(v_a, y, w, u, v, p1, p2));
      }

      ElTerm pe_g_tratio(Var v_a, int n1, int n2, int n3, int n4, int y, int w, int u, int v, XTerm p1, XTerm p2)
      {
            ElTerm e = null;
            if (n1 == y && n2 != y)
            {
      ...
      ElTerm pe_a_itt1(Var v_a, int n1, int n2, int n3, int y, int o, int u, int v)
      {
            int n;
      ...
      ElTerm pe_a_itt(Var v_a, int n1, int n2, int n3, int n4, int y, int w, int u, int v, int r, int p, int q)
      {
            int n;
            ElTerm e1;
            if (xperp(n2, n4, u, v)) return (mk_elim(v_a, trim_a(w, n2, n3, n4), get_n(1L)));
      ...
      ElTerm pe_g_itt1(Var v_a, int n1, int n2, int n3, int y, int o, int u, int v)
      {
            int n;
      ...
      ElTerm pe_g_itt(Var v_a, int n1, int n2, int n3, int n4, int y, int w, int u, int v, int r, int p, int q)
      {
            ElTerm e1;
            int n;
...
*/
      ElTerm pe_v_ipt(Var v_a, int y, int w, int u, int v, int r, int p, int q)
      {
            int n;
            if (w == v)
            {
      ...
      ElTerm pe_r_ipt(Var v_a, int n1, int n2, int d1, int d2, int y, int w, int u, int v, int r, int p, int q)
      {
            if (n2 == y && d2 == y)
            {
                  if (xcoll(n1, w, y))
      ...
      ElTerm pe_a_ipt(Var v_a, int n1, int n2, int n3, int n4, int y, int w, int u, int v, int r, int p, int q)
      {
            if (xpara(n2, n4, u, v))
            {
      ...
      ElTerm pe_g_ipt(Var v_a, int n1, int n2, int n3, int n4, int y, int w, int u, int v, int r, int p, int q)
      {
            int n;
            ElTerm e1;
            XTerm p1, p2;
...
//  if (e1 && sn==-1) e1.p2 = neg_poly(e1.p2);
      ...
      ElTerm pe_v_ipc(Var v_a, int y, int w, int u, int v, int o, int p)
      {
            if (print_geo) gprint("\nCP " + " " + y + " " + w + " " + u + " " + v + " " + o + " " + p);
            switch (v_a.nm)
            {
      ...
      ElTerm pe_r_ipc(Var v_a, int n1, int n2, int d1, int d2, int y, int w, int u, int v, int o, int p)
      {
            if (print_geo) gprint("\nr_icp: " + " " + y + " " + w + " " + u + " " + v + " " + o + " " + p);
      ...
      ElTerm pe_a_ipc(Var v_a, int n1, int n2, int n3, int n4, int y, int w, int u, int v, int o, int p)
      {
            if (w != p) gerror("pe_r_ipc");
      ...
      ElTerm pe_g_ipc(Var v_a, int n1, int n2, int n3, int n4, int y, int w, int u, int v, int o, int p)
      {
            int n;
            Var v1;
            ElTerm e1;
...
//  if (e1 && sn==-1) e1.p2 = neg_poly(e1.p2);
      ...
      ElTerm pe_r_foot(Var v_a, int n1, int n2, int d1, int d2, int y, int p, int u, int v)
      {
            int n;
            ElTerm e1 = null;
            if (v < u)
      ...
      ElTerm pe_a_foot(Var v_a, int n1, int n2, int n3, int n4, int y, int p, int u, int v)
      {
            int n;
            if (v < u)
            {
      ...
      ElTerm pe_g_foot(Var v_a, int n1, int n2, int n3, int n4, int y, int p, int u, int v)
      {
            int n;
            Var v1;
            ElTerm e1;
...
//int n1,n2,n3;
      ...
      ElTerm pe_a_fpt(Var v_a, int n1, int n2, int n3, int n4)
//var  v_a;
//int n1,n2,n3,n4;
      {
            XTerm p0, p1, p2;
...
//int p1,p2,p3;
      ...
      ElTerm pe_circle(Var v_a, int p1, int p2, int p3, int p4)
      {
            int n;
            if (v_a.nm == 2)
            {
...
//int n;
      ...
      ElTerm pe_sc(Var v_a, int p1, int p2)
//var  v_a;
//int p1,p2;
      {
            if (v_a.nm == 6)
      ...
      ElTerm pe_v_bline(Var v_a, int y, int u, int v)
//var  v_a;
//int y,u,v;
      {
            int n;
      ...
      ElTerm pe_g_3bline(Var v_a, int n1, int n2, int n3, int n4, int y, int u, int v)
      {
            if (n1 == v)
            {
      ...
      ElTerm pe_v_square(Var v_a, int p1, int p2, int p3, int sn)
//var  v_a;
//int p1,p2,p3,sn;
      {
      ...
      ElTerm pe_v_ptri(Var v_a, int p1, int p2, int p3)
//var  v_a;
//int p1,p2,p3;
      {
            if (v_a.pt[1] == 0)
      ...
      ElTerm pe_v_ntri(Var v_a, int p1, int p2, int p3)
//var  v_a;
//int p1,p2,p3;
      {
            if (v_a.nm != 4)
      ...
      ElTerm pe_v_sim(Var v_a, int p1, int p2, int p3, int q1, int q2, int q3)
//var  v_a;
//int p1,p2,p3,q1,q2,q3;
      ...
      /////////////////////////////////////////////////////////////////////////elima.cpp
      ElTerm radius_e = new ElTerm();

      ElTerm rcir(int a, int b, int c)
      {
      ...
      ElTerm pe_v_cent(Var v_a, int y, int a, int b, int c)
      {
            int n;
            XTerm p;
      ...
      ElTerm orth_md(Var v_a, int y, int a, int b, int c)
      {
            return (mk_elim(v_a,
...
*/
      ...
      ElTerm pe_a_orth(Var v_a, int n1, int n2, int n3, int n4, int y, int a, int b, int c)
//var  v_a;
//int n1,n2,n3,n4,y,a,b,c;
      {
      ...
      ElTerm pe_g_orth(Var v_a, int n1, int n2, int n3, int n4, int y, int a, int b, int c)
      {
            ElTerm e1, rr;
            int n;
            XTerm r1, r2, r3, r4;
      ...
      ElTerm circum_md(Var v_a, int y, int a, int b, int c)
      {
            return (mk_elim(v_a,
      ...
      ElTerm pe_a_circum(Var v_a, int n1, int n2, int n3, int n4, int y, int a, int b, int c)
      {
            int n;
            if (xperp(n2, n4, b, c))
            {
      ...
      ElTerm pe_g_circum(Var v_a, int n1, int n2, int n3, int n4, int y, int a, int b, int c)
      {
            ElTerm e1;
            XTerm r1, r2, r3, r4;
      ...
      ElTerm pe_r_circum(Var v_a, int n1, int n2, int d1, int d2, int y, int a, int b, int c)
      {
            int a1 = 0, b1 = 0, c1 = 0;
      ...
      ElTerm incent_md(Var v_a, int y, int i, int a, int b)
      {
            return (mk_elim(v_a,
      ...
      ElTerm pe_a_incent(Var v_a, int n1, int n2, int n3, int n4, int y, int i, int a, int b)
      {
            return (incent_md(v_a, y, i, a, b));
      }

      ElTerm pe_g_incent(Var v_a, int n1, int n2, int n3, int n4, int y, int i, int a, int b)
      {
            ElTerm e1;
            int n, sn;
      ...
      ElTerm pe_r_incent(Var v_a, int n1, int n2, int d1, int d2, int y, int i, int a, int b)
      {
            if (n2 == y && d2 == y)
            {
                  return (mk_elim(v_a,
