...
/* gr operations */
    ...
    GrTerm cp_gr(GrTerm gr)
    {
        GrTerm gr1 = mk_gr(gr.c1, gr.ps1, gr.c2, gr.ps2, gr.c, gr.nx);
        if (gr.c == 0)
            gr1.ps = gr.ps;
        else
            gr1.el = gr.el;
